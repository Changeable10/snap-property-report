  ...
  if (step === 2) {
    return (
      <div className="min-h-screen bg-background pb-32">
        ...
        <div className="fixed inset-x-0 z-40 border-t border-border bg-background/95 px-5 py-4 backdrop-blur bottom-[calc(env(safe-area-inset-bottom)+5.25rem)] md:bottom-0">
